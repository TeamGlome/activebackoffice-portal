    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400">
            Here's what's happening with {currentEntity?.name || 'your properties'} today
          </p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-white">{mockDashboardData.overview.activeIntegrations}</p>
                <div className="flex items-center gap-1 mt-1">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-medium text-white">Integration Hub</h3>
                  </div>
                  <p className="text-sm text-slate-400">{mockDashboardData.overview.activeIntegrations} active integrations</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-400">Portfolio management</p>
                  <div className="flex items-center gap-1 mt-2">
                    <Activity className="w-3 h-3 text-blue-400" />
                    <span className="text-xs text-blue-400">24 Properties</span>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-400" />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-medium text-white">AI Analytics</h3>
                  </div>
                  <p className="text-sm text-slate-400">Predictive insights</p>
                  <div className="flex items-center gap-1 mt-2">
                    <Target className="w-3 h-3 text-purple-400" />
                    <span className="text-xs text-purple-400">8 Recommendations</span>
                  </div>
                </div>
                <ChevronRight className="w-5 h-5 text-slate-400" />
              </div>
      ...
      {showCustomDashboard && (
        <div className="fixed inset-0 z-50 bg-black/50">
          <CustomizableDashboard onClose={() => setShowCustomDashboard(false)} />
        </div>
      )}
    </div>
  )
